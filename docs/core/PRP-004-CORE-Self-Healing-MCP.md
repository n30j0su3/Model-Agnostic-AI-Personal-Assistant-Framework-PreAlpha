...
### Scripts
- `core/scripts/error_logger.py`: Logging de intentos de recovery y clasificación ADR-004
- `core/recovery/orchestrator.py`: Recovery orchestration y ejecución de playbooks
- `core/recovery/triggers.py`: Detección de errores recuperables y taxonomy-based triggers
...
### Knowledge Base
- `core/.context/knowledge/errors/`: Logs de errores y recoveries
- `core/.context/knowledge/playbooks/`: Recovery playbooks
...
- [AGENTS-lite.md](../../AGENTS-lite.md) - Bootstrap canónico
- [Error Logs](../../core/.context/knowledge/errors/) - Logs de errores y recoveries
