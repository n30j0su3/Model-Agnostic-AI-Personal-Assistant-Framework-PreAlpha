...
El proceso CORE-008 implementa un sistema modular de extracción automática de conocimiento que analiza las sesiones de trabajo para identificar y preservar:
