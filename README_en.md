...
| 🛠️ **22 Skills included** | Work with Excel, PDF, Word, Markdown, Dashboards, tasks, and more |
...
1. What language do you prefer? (English/Spanish)
2. What AI tool will you use primarily? (OpenCode, Claude, etc.)
...
- A free account with your chosen provider
- API key (we'll show you how to get it in the full documentation)
...
→ **No.** This guide is designed for anyone. If you know basic terminal commands, that's enough.

**Is it free?**
→ **The framework is 100% free** (MIT license). Some AI providers (OpenAI, etc.) may charge for intensive use, but free options are available.
